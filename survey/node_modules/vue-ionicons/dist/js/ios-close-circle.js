(function (global, factory) {
  ...
  //
  var script = {
    name: "ios-close-circle-icon",
    mixins: [IoniconsMixin],
    data: function data() {
      var iconTitle = this.title ? this.title : "Ios Close Circle Icon";
      return {
        iconTitle: iconTitle
      };
    }
  ...
  var __vue_staticRenderFns__ = [];
    ...
    function __vue_normalize__(
      ...
      component.__file = "ios-close-circle.vue";
    ...
    var iosCloseCircle = __vue_normalize__(
