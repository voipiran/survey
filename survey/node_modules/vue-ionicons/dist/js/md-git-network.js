(function (global, factory) {
  ...
  //
  var script = {
    name: "md-git-network-icon",
    mixins: [IoniconsMixin],
    data: function data() {
      var iconTitle = this.title ? this.title : "Md Git Network Icon";
      return {
        iconTitle: iconTitle
      };
    }
  ...
  var __vue_staticRenderFns__ = [];
    ...
    function __vue_normalize__(
      ...
      component.__file = "md-git-network.vue";
    ...
    var mdGitNetwork = __vue_normalize__(
