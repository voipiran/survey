(function (global, factory) {
  ...
  //
  var script = {
    name: "md-notifications-off-icon",
    mixins: [IoniconsMixin],
    data: function data() {
      var iconTitle = this.title ? this.title : "Md Notifications Off Icon";
      return {
        iconTitle: iconTitle
      };
    }
  ...
  var __vue_staticRenderFns__ = [];
    ...
    function __vue_normalize__(
      ...
      component.__file = "md-notifications-off.vue";
    ...
    var mdNotificationsOff = __vue_normalize__(
