(function (global, factory) {
  ...
  //
  var script = {
    name: "md-refresh-circle-icon",
    mixins: [IoniconsMixin],
    data: function data() {
      var iconTitle = this.title ? this.title : "Md Refresh Circle Icon";
      return {
        iconTitle: iconTitle
      };
    }
  ...
  var __vue_staticRenderFns__ = [];
    ...
    function __vue_normalize__(
      ...
      component.__file = "md-refresh-circle.vue";
    ...
    var mdRefreshCircle = __vue_normalize__(
