(function (global, factory) {
  ...
  //
  var script = {
    name: "ios-cloud-circle-icon",
    mixins: [IoniconsMixin],
    data: function data() {
      var iconTitle = this.title ? this.title : "Ios Cloud Circle Icon";
      return {
        iconTitle: iconTitle
      };
    }
  ...
  var __vue_staticRenderFns__ = [];
    ...
    function __vue_normalize__(
      ...
      component.__file = "ios-cloud-circle.vue";
    ...
    var iosCloudCircle = __vue_normalize__(
