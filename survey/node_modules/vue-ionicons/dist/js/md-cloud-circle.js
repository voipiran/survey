(function (global, factory) {
  ...
  //
  var script = {
    name: "md-cloud-circle-icon",
    mixins: [IoniconsMixin],
    data: function data() {
      var iconTitle = this.title ? this.title : "Md Cloud Circle Icon";
      return {
        iconTitle: iconTitle
      };
    }
  ...
  var __vue_staticRenderFns__ = [];
    ...
    function __vue_normalize__(
      ...
      component.__file = "md-cloud-circle.vue";
    ...
    var mdCloudCircle = __vue_normalize__(
