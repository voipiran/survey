(function (global, factory) {
  ...
  //
  var script = {
    name: "ios-refresh-circle-icon",
    mixins: [IoniconsMixin],
    data: function data() {
      var iconTitle = this.title ? this.title : "Ios Refresh Circle Icon";
      return {
        iconTitle: iconTitle
      };
    }
  ...
  var __vue_staticRenderFns__ = [];
    ...
    function __vue_normalize__(
      ...
      component.__file = "ios-refresh-circle.vue";
    ...
    var iosRefreshCircle = __vue_normalize__(
