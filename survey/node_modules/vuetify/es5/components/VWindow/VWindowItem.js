  ...
  methods: {
    ...
    onBeforeTransition: function onBeforeTransition() {
      ...
      if (this.windowGroup.transitionCount === 0) {
        ...
        this.windowGroup.internalHeight = (0, _helpers.convertToUnit)(this.windowGroup.$el.clientHeight);
      }
    ...
    onEnter: function onEnter(el) {
      ...
      this.$nextTick(function () {
        ...
        _this.windowGroup.internalHeight = (0, _helpers.convertToUnit)(el.clientHeight);
      });
    }
  },
